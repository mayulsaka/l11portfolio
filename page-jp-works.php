    ...
    <main class="main">
        ...
        <section id="works" class="works">
            <div class="works__container">
                ...
                <ul class="works__nav">
                    <li class="works__nav-item works__current"><a href="<?php echo home_url(); ?>" class="works__nav-link">すべて</a></li>
                    <li class="works__nav-item"><a href="<?php echo home_url(); ?>" class="works__nav-link">ランディングページ</a></li>
                    <li class="works__nav-item"><a href="<?php echo home_url(); ?>" class="works__nav-link">ウェブサイト</a></li>
                    <li class="works__nav-item"><a href="<?php echo home_url(); ?>" class="works__nav-link">バナー</a></li>
                </ul>
                <div class="works__display">
                    <div class="works__box">
                        <a href="<?php echo home_url(); ?>/jp-work11" class="works__link">
                    ...
                    <div class="works__box">
                        <a href="<?php echo home_url(); ?>/jp-work01" class="works__link">
