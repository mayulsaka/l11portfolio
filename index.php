            ...
            <div class="contact__container">
                ...
                <div class="contact__wrapper">
                    ...
                    <form class="form">
                        ...
                        <div class="form__item">
                            <label for="email" class="form__label">
                                <span class="form__must">E-mail address (for verification)<span class="magenta">*</span></span>
                            </label>
                            <div class="form__input-wrapper">
                        ...
                        <div class="form__item">
                            <label for="inquiry" class="form__label">
                                <span class="form__must">Inquiry<span class="magenta">*</span></span>
                            </label>
                        ...
                        <div class="form__item form__privacy-wrapper">
                            <span class="form__must">Please check the privacy policy below before clicking the send button.<span class="magenta">*</span></span>
                        </div>
