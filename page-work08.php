...
<main class="main">
    ...
    <section id="work-details" class="work-details">
            ...
            <div class="work-details__box">
                ...
                <div class="work-details__box-description">
                    ...
                    <div class="work-details__description">
                        ...
                        <ul class="work-details__description-list--remark">
                            <li class="work-details__description-list-item--url">
                                <span class="work-details__description-text"><a href="http://demo.mayumi-sakaguchi-dev.com/lp1" target="_blank">http://demo.mayumi-sakaguchi-dev.com/lp1</a></span>
                            </li>
                    ...
                    <div class="work-details__description">
                        ...
                        <span class="work-details__description-text">2024/11(2 weeks)</span>
                    </div>
                    <div class="work-details__description">
                    ...
                    <div class="work-details__description">
                        ...
                        <span class="work-details__description-text">HTML, CSS, JavaScript*, jQuery*, VS Code, Adobe XD, Photoshop (*modification)</span>
                    </div>
                    <div class="work-details__description">
                    ...
                    <div class="work-details__description">
                        ...
                        <ul class="work-details__description-list">
                            ...
                            <li class="work-details__description-list-item">
                                Created smooth scrolling for anchor links in the header.
                            </li>
                            <li class="work-details__description-list-item">
                                Created a hamburger menu for smartphones (slide type).
                            </li>
                            <li class="work-details__description-list-item">
                                Created tab switching (HTML and CSS only).
                            </li>
                            <li class="work-details__description-list-item">
                                Created some images to expand on mouseover.
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="pagination">
            <a class="prev page-numbers" href="<?php echo home_url(); ?>/work07">«</a>
            <a class="next page-numbers" href="<?php echo home_url(); ?>/work09">»</a>
        </div>
