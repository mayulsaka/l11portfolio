    ...
    <div class="breadcrumb">
        ...
        <section id="work-details" class="work-details">
                ...
                <div class="work-details__box">
                    ...
                    <div class="work-details__box-description">
                        <div class="work-details__description">
                            ...
                            <span class="work-details__description-text">ランディングページ（美容コスメ）</span>
                        </div>
                        <div class="work-details__description">
                        ...
                        <div class="work-details__description">
                            ...
                            <span class="work-details__description-text">2024/12（2週間）</span>
                        </div>
                        <div class="work-details__description">
                        ...
                        <div class="work-details__description">
                            ...
                            <ul class="work-details__description-list">
                                ...
                                <li class="work-details__description-list-item">
                                    一部カルーセルで切り替わる形に実装(Slick)
                                </li>
                                <li class="work-details__description-list-item">
                                    一部アコーディオンで表示・非表示可能な形で実装（HTML・CSSのみ）
                                </li>
                                <li class="work-details__description-list-item">
                                    トップへ戻るボタンを、下にスクロールするとふわっと現れて、フッターの上で止まる形に実装
                                    等。
                                </li>
                            </ul>
                        </div>
            ...
            <div class="pagination">
                <a class="prev page-numbers" href="<?php echo home_url(); ?>/jp-work-08">«</a>
                <a class="next page-numbers" href="<?php echo home_url(); ?>/jp-work-10">»</a>
            </div>
