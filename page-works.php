    ...
    <section id="works" class="works">
        <div class="works__container">
            ...
            <ul class="filter-list">
                <li data-filter="all" class="nav-item is-active"><span>All</span></li>
                <li data-filter="cat1" class="nav-item"><span>Website</span></li>
                <li data-filter="cat2" class="nav-item"><span>Landing page</span></li>
                <li data-filter="cat3" class="nav-item"><span>Other</span></li>
            </ul>
